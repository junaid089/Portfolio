...
export const meta = () => {
  return baseMeta({
    ...
    prefix: "Articles",
    ogImage: "https://junaidas.in/static/erms_dashboard_mockup.png",
    ogType: "article",
    canonicalUrl: "https://junaidas.in/articles/erms-database-architecture",
    keywords: [
      "ERMS Database Optimization",
      "Flask Connection Pooling",
      "SQLYOG MySQL Indexing",
      "Database Window Functions",
      "Junaid A S",
      "Junaid Backend Architecture"
    ]
  });
};
